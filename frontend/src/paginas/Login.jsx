                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="email" placeholder="Enter you email" name="email" value={form.email} onChange={handleChange}
                        ...
                        <div className="my-4">
                        <button type="submit" className="py-2 w-full block text-center bg-gray-500 text-slate-300 border rounded-xl hover:scale-100 duration-300 hover:bg-gray-900 hover:text-white">Login</button>
                        </div>
